...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/dd-sekolah/dd-sekolah-030.json').then(response => {
      ...
      this.bar.title.text = res[0].xAxis.region + ' ' + res[0].xAxis.name;
      ...
      setInterval(() => {
        ...
        this.bar.title.text = res[i].xAxis.region + ' ' + res[i].xAxis.name;
